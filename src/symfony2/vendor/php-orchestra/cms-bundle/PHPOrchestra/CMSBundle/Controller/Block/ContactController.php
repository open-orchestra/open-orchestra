...
class ContactController extends Controller
{
    ...
    function showAction($id,$class){
    	...
    	return $this->render('PHPOrchestraCMSBundle:Block/Contact:show.html.twig', array(
	...
	function showBackAction($id,$class)
	{
		...
		return $this->render('PHPOrchestraCMSBundle:Block/Contact:showBack.html.twig', array(
				'form' => $form->createView()));
	}
