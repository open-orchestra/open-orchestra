...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/workspace-php/Orchestra/src/symfony2/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_2b57f63b495117c0e9e0b8e59ac9d4265daf1ddd22dc78d6807cbd3066f322e6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2b57f63b495117c0e9e0b8e59ac9d4265daf1ddd22dc78d6807cbd3066f322e6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2b57f63b495117c0e9e0b8e59ac9d4265daf1ddd22dc78d6807cbd3066f322e6');
        ...
        $d->setProxyDir('D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/workspace-php/Orchestra/src/symfony2/app/Resources');
    }
    ...
    {
        return $this->services['mandango.cache.filesystem'] = new \Mandango\Cache\FilesystemCache('D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/mandango/cache');
    }
    ...
    {
        return $this->services['mandango.extension.core'] = new \Mandango\Extension\Core(array('metadata_factory_class' => 'MandangoMetadataFactory', 'metadata_factory_output' => 'D:/workspace-php/Orchestra/src/symfony2/app/'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/workspace-php/Orchestra/src/symfony2/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/workspace-php/Orchestra/src/symfony2/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/workspace-php/Orchestra/src/symfony2/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/workspace-php/Orchestra/src/symfony2/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\analytik\\mandango-bundle\\Mandango\\MandangoBundle/Resources/views', 'Mandango');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\php-orchestra\\cms-bundle\\PHPOrchestra\\CMSBundle/Resources/views', 'PHPOrchestraCMS');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/workspace-php/Orchestra/src/symfony2/app/Resources/views');
        $instance->addPath('D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('$php-orchestra$');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/workspace-php/Orchestra/src/symfony2/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev',
            'kernel.logs_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/logs',
            'kernel.bundles' => array(
                ...
                'PHPOrchestraCMSBundle' => 'PHPOrchestra\\CMSBundle\\PHPOrchestraCMSBundle',
            ...
            'debug.container.dump' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '$php-orchestra$',
            ...
            'session.save_path' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\workspace-php\\Orchestra\\src\\symfony2\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/workspace-php/Orchestra/src/symfony2/app/../web',
            'assetic.write_to' => 'D:/workspace-php/Orchestra/src/symfony2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/doctrine/orm/Proxies',
            ...
            'mandango.model_dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/',
            'mandango.metadata_factory.output' => 'D:/workspace-php/Orchestra/src/symfony2/app/',
            'mandango.cache.filesystem_cache.class' => 'Mandango\\Cache\\FilesystemCache',
            'mandango.cache.filesystem_cache.dir' => 'D:/workspace-php/Orchestra/src/symfony2/app/cache/dev/mandango/cache',
