...
/**
 * Base class of repository of Model\PHPOrchestraCMSBundle\ContentAttribute document.
 */
abstract class ContentAttributeRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\PHPOrchestraCMSBundle\ContentAttribute';
        $this->isFile = false;
