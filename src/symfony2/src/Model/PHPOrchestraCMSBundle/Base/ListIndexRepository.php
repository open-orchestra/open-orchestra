...
/**
 * Base class of repository of Model\PHPOrchestraCMSBundle\ListIndex document.
 */
abstract class ListIndexRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\PHPOrchestraCMSBundle\ListIndex';
        $this->isFile = false;
        $this->collectionName = 'listIndex';
