...
/**
 * Base class of query of Model\PHPOrchestraCMSBundle\ContentAttribute document.
 */
abstract class ContentAttributeQuery extends \Mandango\Query
{
    /**
     * {@inheritdoc}
     */
        ...
        if ($references = $this->getReferences()) {
            ...
            foreach ($references as $referenceName) {
                ...
                throw new \RuntimeException(
                    sprintf('The reference "%s" does not exist in the class "%s".', $referenceName, $documentClass)
                );
            }
        }
