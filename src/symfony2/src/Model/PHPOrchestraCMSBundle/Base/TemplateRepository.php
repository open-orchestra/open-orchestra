...
/**
 * Base class of repository of Model\PHPOrchestraCMSBundle\Template document.
 */
abstract class TemplateRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\PHPOrchestraCMSBundle\Template';
        $this->isFile = false;
