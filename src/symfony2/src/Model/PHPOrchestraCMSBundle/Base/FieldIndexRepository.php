...
/**
 * Base class of repository of Model\PHPOrchestraCMSBundle\FieldIndex document.
 */
abstract class FieldIndexRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\PHPOrchestraCMSBundle\FieldIndex';
        $this->isFile = false;
        $this->collectionName = 'fieldIndex';
